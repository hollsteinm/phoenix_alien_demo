defmodule AlienDemoWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule AlienDemo.MyChannel do
        use AlienDemoWeb, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :alien_demo,
                        pubsub_server: AlienDemo.PubSub
end
